...
title: HTTP 范围请求
date: 2026-04-25
description: "MDN HTTP 指南：HTTP 范围请求"
categories:
  - 网络安全
  - HTTP
tags:
...
!!! info "来源声明"
    本文照搬整理自 MDN Web Docs 中文文档：[https://mdn.org.cn/zh-CN/docs/Web/HTTP/Guides/Range_requests](https://mdn.org.cn/zh-CN/docs/Web/HTTP/Guides/Range_requests)。
...
- 相关状态码 `200`、`206`、`416`。
- 相关标头：`Accept-Ranges`、`Range`、`Content-Range`、`If-Range`、`Transfer-Encoding`。
